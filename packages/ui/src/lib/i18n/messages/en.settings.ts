export const settingsDict = {
  ...
  'settings.providers.page.goMultiAuth.title': 'OpenCode Go accounts',
  'settings.providers.page.goMultiAuth.description': 'Store multiple OpenCode Go API keys and switch which key is copied into OpenCode auth.',
  'settings.providers.page.goMultiAuth.empty': 'No saved OpenCode Go accounts.',
  'settings.providers.page.goMultiAuth.current': 'Current account',
  'settings.providers.page.goMultiAuth.addAccountLabel': 'Add account',
  'settings.providers.page.goMultiAuth.addAccountInfo': 'Saves the key in ~/.config/opencode/opencode-go-accounts.json and restarts managed OpenCode when the active key changes.',
  'settings.providers.page.goMultiAuth.labelLabel': 'Account label',
  'settings.providers.page.goMultiAuth.labelPlaceholder': 'Label (optional)',
  'settings.providers.page.goMultiAuth.apiKeyLabel': 'OpenCode Go API key',
  'settings.providers.page.goMultiAuth.apiKeyPlaceholder': 'OpenCode Go API key',
  'settings.providers.page.goMultiAuth.actions.switch': 'Switch account',
  'settings.providers.page.goMultiAuth.actions.switching': 'Switching...',
  'settings.providers.page.goMultiAuth.actions.remove': 'Remove',
  'settings.providers.page.goMultiAuth.actions.removing': 'Removing...',
  'settings.providers.page.goMultiAuth.actions.add': 'Add account',
  'settings.providers.page.goMultiAuth.actions.adding': 'Adding...',
  'settings.providers.page.goMultiAuth.toast.loadFailed': 'Failed to load OpenCode Go accounts',
  'settings.providers.page.goMultiAuth.toast.apiKeyRequired': 'OpenCode Go API key is required',
  'settings.providers.page.goMultiAuth.toast.addFailed': 'Failed to add OpenCode Go account',
  'settings.providers.page.goMultiAuth.toast.added': 'OpenCode Go account added',
  'settings.providers.page.goMultiAuth.toast.switchFailed': 'Failed to switch OpenCode Go account',
  'settings.providers.page.goMultiAuth.toast.switched': 'OpenCode Go account switched',
  'settings.providers.page.goMultiAuth.toast.removeFailed': 'Failed to remove OpenCode Go account',
  'settings.providers.page.goMultiAuth.toast.removed': 'OpenCode Go account removed',
  'settings.providers.page.goMultiAuth.toast.restartFailed': 'Account changed, but OpenCode restart failed',
  'settings.providers.page.goMultiAuth.toast.externalRestartRequired': 'Account saved. Restart the connected OpenCode server to use it.',
