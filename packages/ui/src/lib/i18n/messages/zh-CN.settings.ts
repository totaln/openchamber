...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.page.goMultiAuth.title': 'OpenCode Go 账户',
  'settings.providers.page.goMultiAuth.description': '保存多个 OpenCode Go API Key，并切换要复制到 OpenCode 认证中的密钥。',
  'settings.providers.page.goMultiAuth.empty': '没有保存的 OpenCode Go 账户。',
  'settings.providers.page.goMultiAuth.current': '当前账户',
  'settings.providers.page.goMultiAuth.addAccountLabel': '添加账户',
  'settings.providers.page.goMultiAuth.addAccountInfo': '密钥会保存到 ~/.config/opencode/opencode-go-accounts.json；活动密钥变化时会重启托管的 OpenCode。',
  'settings.providers.page.goMultiAuth.labelLabel': '账户标签',
  'settings.providers.page.goMultiAuth.labelPlaceholder': '标签（可选）',
  ...
  'settings.providers.page.goMultiAuth.actions.switch': '切换账户',
  'settings.providers.page.goMultiAuth.actions.switching': '正在切换...',
  'settings.providers.page.goMultiAuth.actions.remove': '移除',
  'settings.providers.page.goMultiAuth.actions.removing': '正在移除...',
  'settings.providers.page.goMultiAuth.actions.add': '添加账户',
  'settings.providers.page.goMultiAuth.actions.adding': '正在添加...',
  'settings.providers.page.goMultiAuth.toast.loadFailed': '加载 OpenCode Go 账户失败',
  'settings.providers.page.goMultiAuth.toast.apiKeyRequired': 'OpenCode Go API Key 为必填项',
  'settings.providers.page.goMultiAuth.toast.addFailed': '添加 OpenCode Go 账户失败',
  'settings.providers.page.goMultiAuth.toast.added': 'OpenCode Go 账户已添加',
  'settings.providers.page.goMultiAuth.toast.switchFailed': '切换 OpenCode Go 账户失败',
  'settings.providers.page.goMultiAuth.toast.switched': 'OpenCode Go 账户已切换',
  'settings.providers.page.goMultiAuth.toast.removeFailed': '移除 OpenCode Go 账户失败',
  'settings.providers.page.goMultiAuth.toast.removed': 'OpenCode Go 账户已移除',
  'settings.providers.page.goMultiAuth.toast.restartFailed': '账户已更改，但 OpenCode 重启失败',
  'settings.providers.page.goMultiAuth.toast.externalRestartRequired': '账户已保存。请重启已连接的 OpenCode 服务器后再使用。',
