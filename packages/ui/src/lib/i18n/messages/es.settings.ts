...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.page.goMultiAuth.title": "Cuentas de OpenCode Go",
  "settings.providers.page.goMultiAuth.description": "Guarda varias claves API de OpenCode Go y cambia qué clave se copia en la autenticación de OpenCode.",
  "settings.providers.page.goMultiAuth.empty": "No hay cuentas de OpenCode Go guardadas.",
  "settings.providers.page.goMultiAuth.current": "Cuenta actual",
  "settings.providers.page.goMultiAuth.addAccountLabel": "Añadir cuenta",
  "settings.providers.page.goMultiAuth.addAccountInfo": "Guarda la clave en ~/.config/opencode/opencode-go-accounts.json y reinicia OpenCode gestionado cuando cambia la clave activa.",
  "settings.providers.page.goMultiAuth.labelLabel": "Etiqueta de cuenta",
  "settings.providers.page.goMultiAuth.labelPlaceholder": "Etiqueta (opcional)",
  "settings.providers.page.goMultiAuth.apiKeyLabel": "Clave API de OpenCode Go",
  "settings.providers.page.goMultiAuth.apiKeyPlaceholder": "Clave API de OpenCode Go",
  "settings.providers.page.goMultiAuth.actions.switch": "Cambiar cuenta",
  "settings.providers.page.goMultiAuth.actions.switching": "Cambiando...",
  "settings.providers.page.goMultiAuth.actions.remove": "Eliminar",
  "settings.providers.page.goMultiAuth.actions.removing": "Eliminando...",
  "settings.providers.page.goMultiAuth.actions.add": "Añadir cuenta",
  "settings.providers.page.goMultiAuth.actions.adding": "Añadiendo...",
  "settings.providers.page.goMultiAuth.toast.loadFailed": "No se pudieron cargar las cuentas de OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.apiKeyRequired": "La clave API de OpenCode Go es obligatoria",
  "settings.providers.page.goMultiAuth.toast.addFailed": "No se pudo añadir la cuenta de OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.added": "Cuenta de OpenCode Go añadida",
  "settings.providers.page.goMultiAuth.toast.switchFailed": "No se pudo cambiar la cuenta de OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.switched": "Cuenta de OpenCode Go cambiada",
  "settings.providers.page.goMultiAuth.toast.removeFailed": "No se pudo eliminar la cuenta de OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.removed": "Cuenta de OpenCode Go eliminada",
  "settings.providers.page.goMultiAuth.toast.restartFailed": "La cuenta cambió, pero falló el reinicio de OpenCode",
  "settings.providers.page.goMultiAuth.toast.externalRestartRequired": "Cuenta guardada. Reinicia el servidor OpenCode conectado para usarla.",
