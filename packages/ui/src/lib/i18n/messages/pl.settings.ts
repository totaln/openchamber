export const settingsDict = {
  ...
  'settings.providers.page.goMultiAuth.title': 'Konta OpenCode Go',
  'settings.providers.page.goMultiAuth.description': 'Zapisuj wiele kluczy API OpenCode Go i przełączaj klucz kopiowany do uwierzytelniania OpenCode.',
  'settings.providers.page.goMultiAuth.empty': 'Brak zapisanych kont OpenCode Go.',
  'settings.providers.page.goMultiAuth.current': 'Bieżące konto',
  'settings.providers.page.goMultiAuth.addAccountLabel': 'Dodaj konto',
  'settings.providers.page.goMultiAuth.addAccountInfo': 'Zapisuje klucz w ~/.config/opencode/opencode-go-accounts.json i ponownie uruchamia zarządzany OpenCode, gdy aktywny klucz się zmieni.',
  'settings.providers.page.goMultiAuth.labelLabel': 'Etykieta konta',
  'settings.providers.page.goMultiAuth.labelPlaceholder': 'Etykieta (opcjonalnie)',
  'settings.providers.page.goMultiAuth.apiKeyLabel': 'Klucz API OpenCode Go',
  'settings.providers.page.goMultiAuth.apiKeyPlaceholder': 'Klucz API OpenCode Go',
  'settings.providers.page.goMultiAuth.actions.switch': 'Przełącz konto',
  'settings.providers.page.goMultiAuth.actions.switching': 'Przełączanie...',
  'settings.providers.page.goMultiAuth.actions.remove': 'Usuń',
  'settings.providers.page.goMultiAuth.actions.removing': 'Usuwanie...',
  'settings.providers.page.goMultiAuth.actions.add': 'Dodaj konto',
  'settings.providers.page.goMultiAuth.actions.adding': 'Dodawanie...',
  'settings.providers.page.goMultiAuth.toast.loadFailed': 'Nie udało się załadować kont OpenCode Go',
  'settings.providers.page.goMultiAuth.toast.apiKeyRequired': 'Klucz API OpenCode Go jest wymagany',
  'settings.providers.page.goMultiAuth.toast.addFailed': 'Nie udało się dodać konta OpenCode Go',
  'settings.providers.page.goMultiAuth.toast.added': 'Konto OpenCode Go zostało dodane',
  'settings.providers.page.goMultiAuth.toast.switchFailed': 'Nie udało się przełączyć konta OpenCode Go',
  'settings.providers.page.goMultiAuth.toast.switched': 'Konto OpenCode Go zostało przełączone',
  'settings.providers.page.goMultiAuth.toast.removeFailed': 'Nie udało się usunąć konta OpenCode Go',
  'settings.providers.page.goMultiAuth.toast.removed': 'Konto OpenCode Go zostało usunięte',
  'settings.providers.page.goMultiAuth.toast.restartFailed': 'Konto zostało zmienione, ale ponowne uruchomienie OpenCode nie powiodło się',
  'settings.providers.page.goMultiAuth.toast.externalRestartRequired': 'Konto zapisane. Uruchom ponownie połączony serwer OpenCode, aby go użyć.',
