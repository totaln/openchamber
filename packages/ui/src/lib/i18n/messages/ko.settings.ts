...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.page.goMultiAuth.title': 'OpenCode Go 계정',
  'settings.providers.page.goMultiAuth.description': '여러 OpenCode Go API 키를 저장하고 OpenCode 인증에 복사할 키를 전환합니다.',
  'settings.providers.page.goMultiAuth.empty': '저장된 OpenCode Go 계정이 없습니다.',
  'settings.providers.page.goMultiAuth.current': '현재 계정',
  'settings.providers.page.goMultiAuth.addAccountLabel': '계정 추가',
  'settings.providers.page.goMultiAuth.addAccountInfo': '키는 ~/.config/opencode/opencode-go-accounts.json에 저장되며 활성 키가 바뀌면 관리되는 OpenCode가 다시 시작됩니다.',
  'settings.providers.page.goMultiAuth.labelLabel': '계정 라벨',
  'settings.providers.page.goMultiAuth.labelPlaceholder': '라벨(선택 사항)',
  'settings.providers.page.goMultiAuth.apiKeyLabel': 'OpenCode Go API 키',
  'settings.providers.page.goMultiAuth.apiKeyPlaceholder': 'OpenCode Go API 키',
  'settings.providers.page.goMultiAuth.actions.switch': '계정 전환',
  'settings.providers.page.goMultiAuth.actions.switching': '전환 중...',
  'settings.providers.page.goMultiAuth.actions.remove': '제거',
  'settings.providers.page.goMultiAuth.actions.removing': '제거 중...',
  'settings.providers.page.goMultiAuth.actions.add': '계정 추가',
  'settings.providers.page.goMultiAuth.actions.adding': '추가 중...',
  'settings.providers.page.goMultiAuth.toast.loadFailed': 'OpenCode Go 계정을 불러오지 못했습니다',
  'settings.providers.page.goMultiAuth.toast.apiKeyRequired': 'OpenCode Go API 키가 필요합니다',
  'settings.providers.page.goMultiAuth.toast.addFailed': 'OpenCode Go 계정을 추가하지 못했습니다',
  'settings.providers.page.goMultiAuth.toast.added': 'OpenCode Go 계정이 추가되었습니다',
  'settings.providers.page.goMultiAuth.toast.switchFailed': 'OpenCode Go 계정을 전환하지 못했습니다',
  'settings.providers.page.goMultiAuth.toast.switched': 'OpenCode Go 계정이 전환되었습니다',
  'settings.providers.page.goMultiAuth.toast.removeFailed': 'OpenCode Go 계정을 제거하지 못했습니다',
  'settings.providers.page.goMultiAuth.toast.removed': 'OpenCode Go 계정이 제거되었습니다',
  'settings.providers.page.goMultiAuth.toast.restartFailed': '계정이 변경되었지만 OpenCode 재시작에 실패했습니다',
  'settings.providers.page.goMultiAuth.toast.externalRestartRequired': '계정이 저장되었습니다. 사용하려면 연결된 OpenCode 서버를 다시 시작하세요.',
