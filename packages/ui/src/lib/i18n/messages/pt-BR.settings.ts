...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.providers.page.goMultiAuth.title": "Contas do OpenCode Go",
  "settings.providers.page.goMultiAuth.description": "Salve várias chaves API do OpenCode Go e alterne qual chave é copiada para a autenticação do OpenCode.",
  "settings.providers.page.goMultiAuth.empty": "Nenhuma conta do OpenCode Go salva.",
  "settings.providers.page.goMultiAuth.current": "Conta atual",
  "settings.providers.page.goMultiAuth.addAccountLabel": "Adicionar conta",
  "settings.providers.page.goMultiAuth.addAccountInfo": "Salva a chave em ~/.config/opencode/opencode-go-accounts.json e reinicia o OpenCode gerenciado quando a chave ativa muda.",
  "settings.providers.page.goMultiAuth.labelLabel": "Rótulo da conta",
  "settings.providers.page.goMultiAuth.labelPlaceholder": "Rótulo (opcional)",
  "settings.providers.page.goMultiAuth.apiKeyLabel": "Chave API do OpenCode Go",
  "settings.providers.page.goMultiAuth.apiKeyPlaceholder": "Chave API do OpenCode Go",
  "settings.providers.page.goMultiAuth.actions.switch": "Alternar conta",
  "settings.providers.page.goMultiAuth.actions.switching": "Alternando...",
  "settings.providers.page.goMultiAuth.actions.remove": "Remover",
  "settings.providers.page.goMultiAuth.actions.removing": "Removendo...",
  "settings.providers.page.goMultiAuth.actions.add": "Adicionar conta",
  "settings.providers.page.goMultiAuth.actions.adding": "Adicionando...",
  "settings.providers.page.goMultiAuth.toast.loadFailed": "Não foi possível carregar as contas do OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.apiKeyRequired": "A chave API do OpenCode Go é obrigatória",
  "settings.providers.page.goMultiAuth.toast.addFailed": "Não foi possível adicionar a conta do OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.added": "Conta do OpenCode Go adicionada",
  "settings.providers.page.goMultiAuth.toast.switchFailed": "Não foi possível alternar a conta do OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.switched": "Conta do OpenCode Go alternada",
  "settings.providers.page.goMultiAuth.toast.removeFailed": "Não foi possível remover a conta do OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.removed": "Conta do OpenCode Go removida",
  "settings.providers.page.goMultiAuth.toast.restartFailed": "A conta foi alterada, mas a reinicialização do OpenCode falhou",
  "settings.providers.page.goMultiAuth.toast.externalRestartRequired": "Conta salva. Reinicie o servidor OpenCode conectado para usá-la.",
