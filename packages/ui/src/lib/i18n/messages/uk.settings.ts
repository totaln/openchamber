...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.page.goMultiAuth.title": "Облікові записи OpenCode Go",
  "settings.providers.page.goMultiAuth.description": "Зберігайте кілька API-ключів OpenCode Go та перемикайте ключ, який копіюється в автентифікацію OpenCode.",
  "settings.providers.page.goMultiAuth.empty": "Немає збережених облікових записів OpenCode Go.",
  "settings.providers.page.goMultiAuth.current": "Поточний обліковий запис",
  "settings.providers.page.goMultiAuth.addAccountLabel": "Додати обліковий запис",
  "settings.providers.page.goMultiAuth.addAccountInfo": "Зберігає ключ у ~/.config/opencode/opencode-go-accounts.json і перезапускає керований OpenCode, коли активний ключ змінюється.",
  "settings.providers.page.goMultiAuth.labelLabel": "Мітка облікового запису",
  "settings.providers.page.goMultiAuth.labelPlaceholder": "Мітка (необов'язково)",
  "settings.providers.page.goMultiAuth.apiKeyLabel": "API-ключ OpenCode Go",
  "settings.providers.page.goMultiAuth.apiKeyPlaceholder": "API-ключ OpenCode Go",
  "settings.providers.page.goMultiAuth.actions.switch": "Перемкнути обліковий запис",
  "settings.providers.page.goMultiAuth.actions.switching": "Перемикання...",
  "settings.providers.page.goMultiAuth.actions.remove": "Видалити",
  "settings.providers.page.goMultiAuth.actions.removing": "Видалення...",
  "settings.providers.page.goMultiAuth.actions.add": "Додати обліковий запис",
  "settings.providers.page.goMultiAuth.actions.adding": "Додавання...",
  "settings.providers.page.goMultiAuth.toast.loadFailed": "Не вдалося завантажити облікові записи OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.apiKeyRequired": "Потрібен API-ключ OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.addFailed": "Не вдалося додати обліковий запис OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.added": "Обліковий запис OpenCode Go додано",
  "settings.providers.page.goMultiAuth.toast.switchFailed": "Не вдалося перемкнути обліковий запис OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.switched": "Обліковий запис OpenCode Go перемкнено",
  "settings.providers.page.goMultiAuth.toast.removeFailed": "Не вдалося видалити обліковий запис OpenCode Go",
  "settings.providers.page.goMultiAuth.toast.removed": "Обліковий запис OpenCode Go видалено",
  "settings.providers.page.goMultiAuth.toast.restartFailed": "Обліковий запис змінено, але перезапуск OpenCode не вдався",
  "settings.providers.page.goMultiAuth.toast.externalRestartRequired": "Обліковий запис збережено. Перезапустіть підключений сервер OpenCode, щоб використовувати його.",
